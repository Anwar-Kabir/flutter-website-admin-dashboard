            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        const Text("Magazine Event 1"),
                         const SizedBox(height: 16),
                        AppTextForm(
                    assetPath: "assets/icons/mail_light.svg",
                    controller: _appFormState.chairmanDetailsController,
                    hintText: "Magazine Event Title",
                    validator: _appValidation.validateText,
                    maxLines: 1,
                    ),
                ...
                Container(
                  decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(5),
                    color: const Color.fromARGB(255, 161, 159, 150)
                  ),
                  child: Padding(
                    padding: const EdgeInsets.all(8.0),
                    child: Column(
