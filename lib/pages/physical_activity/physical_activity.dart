            ...
            child: Column(
              ...
              children: [
                ...
                AppTextForm(
                  ...
                  hintText: "Physical Activity Title",
                ...
                AppTextForm(
                  ...
                  hintText: "Physical Activity Details",
                  validator: _appValidation.validateText,
                  maxLines: 5,
                ),
                const SizedBox(height: 16),
                Container(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        const Text("Physical Activity Event 1"),
                        Center(
                          child: Stack(
                            children: [
                              CircleAvatar(
                                radius: 50,
                                backgroundImage: _appValidation
                                            .selectedImageBase64 !=
                                        null
                        ...
                        AppTextForm(
                          ...
                          hintText: "Physical Activity Event Title",
                          validator: _appValidation.validateText,
                          maxLines: 1,
                        ),
                        const SizedBox(height: 16),
                        AppTextForm(
                          ...
                          onTap: () async {
                            ...
                            _appFormState.dateController.text =
                                _appValidation.selectedDate;
                ...
                Container(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        const Text("Physical Activity Event 2"),
                        const SizedBox(height: 16),
                        Center(
                          child: Stack(
                            children: [
                        ...
                        AppTextForm(
                          assetPath: "assets/icons/mail_light.svg",
                          controller:
                              _appFormState.studentAdmisionDateController,
                          ...
                          onTap: () async {
                            ...
                            _appFormState.studentAdmisionDateController.text =
                                _appValidation.selectedAdmissionDate;

                            // Update the UI
                            setState(() {});
                          },
                          readOnly:
                              true, // Prevents the keyboard from showing up
                        ),
                        const SizedBox(height: 16),
                      ],
                    ),
